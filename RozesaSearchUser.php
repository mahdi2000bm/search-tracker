...
Description: لیست سرچ های کاربر را به برای ما ذخیره میکند - رزسا
*Author: mhdibaqri 
*Author URI: #
*/
    ...
    define( 'RSUPATHDIR' , plugin_dir_path(__FILE__));
    ...
    if ( !class_exists( 'ADR_CrateTable' ) ) {
        ...
        class ADR_CrateTable {
            public function __construct() {
                include( RSUPATHDIR . '/inc/activation.php' );
    ...
    if (is_admin()){ include( RSUPATHDIR . '/inc/adminMenus.php' ); }
    include( RSUPATHDIR . '/inc/addScripts.php' );
    include( RSUPATHDIR . '/inc/ajaxHandler.php' );   